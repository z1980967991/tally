...
import com.zy.tally.adapter.ChartVPAdapter;
import com.zy.tally.db.DBManager;
import com.zy.tally.frag_chart.IncomChartFragment;
import com.zy.tally.frag_chart.OutcomChartFragment;
import com.zy.tally.utils.CalendarDialog;
    ...
    private void showCalendarDialog() {
        ...
        dialog.setOnRefreshListener(new CalendarDialog.OnRefreshListener() {
            ...
            public void onRefresh(int selPos, int year, int month) {
                com.zy.tally.MonthChartActivity.this.selectPos = selPos;
                com.zy.tally.MonthChartActivity.this.selectMonth = month;
                initStatistics(year,month);
